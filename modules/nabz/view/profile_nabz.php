...
<!--<p>
	<span class="label_profile"> Serial : </span> <?php echo htmlspecialchars($nabz_serial); ?> <br \>
	<span class="label_profile"> Token : </span> <?php echo htmlspecialchars($nabz_token); ?> <br \>
</p> --!>
